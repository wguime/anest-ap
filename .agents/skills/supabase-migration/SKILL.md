...
Antes de aplicar, o agente `migration-validator` revisa o SQL (AGENTS.md). Aplicar com `node scripts/deploy-sp21-mgmt-api.mjs apply-migration <path>` (o CLI do Supabase não está instalado) ou `mcp__supabase__apply_migration`.
