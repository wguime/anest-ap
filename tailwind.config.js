  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Organograma: cores aplicadas via inline-style var(--org-*) (ver
        // anest-theme.css + orgNodeColors.js). NÃO registradas como utilities
        // Tailwind — classes dinâmicas bg-org-${tipo} seriam purgadas pelo JIT.
      },
      borderRadius: {
        lg: "var(--radius)",
