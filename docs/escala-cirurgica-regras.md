...
| Casos fora do rodapé | Usuário que aparece apenas em casos (inclusive após troca desfeita) permanece visível para preservar o histórico, mas não recebe número/posição da ordem publicada, não bloqueia a fila e é identificado como “Fora do rodapé”. | `colunaLiberacao.js`; `LiberacoesView.jsx` | `escalaCirurgicaPersonas.test.jsx`; regressão de troca |
