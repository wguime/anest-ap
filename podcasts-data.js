...
console.log('✅ Dados de podcasts carregados:', Object.keys(window.podcastsData).length, 'categorias');

// Garantir que podcastsData não seja sobrescrito
if (window.podcastsData && Object.keys(window.podcastsData).length > 0) {
    console.log('✅ Podcasts preservados:', Object.keys(window.podcastsData));
}
