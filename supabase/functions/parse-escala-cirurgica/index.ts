...
const HOSPITAL_HINT: Record<string, string> = {
  ...
  hro:
    ...
    '(2) As seções EXAMES, IMAGEM e HEMO/HEMODINÂMICA ficam FORA da grade principal (costumam vir abaixo dela, em blocos pequenos, às vezes com uma linha só) e são as que mais escapam: percorra a imagem INTEIRA, de cima até depois do fim da tabela, e extraia essas linhas como casos — cada uma com o anestesista da PRÓPRIA linha. Se elas não existirem na imagem, tudo bem; o que não pode é deixá-las de fora por não estarem na grade. ' +
