...
- anestesista: copie EXATAMENTE a célula DA PRÓPRIA LINHA, inclusive "//" (significa "mesmo da linha acima"). NUNCA espalhe o nome de uma linha para outras que têm nome próprio, e NUNCA atribua anestesista que a imagem não mostra naquela linha — na dúvida, "" (célula vazia).
