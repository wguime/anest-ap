-- S0.3: Restringir notificação de denúncias a admins only (não coordenadores)
-- Antes: notify_responsaveis_on_incidente notificava todos coordenadores sobre denúncias
