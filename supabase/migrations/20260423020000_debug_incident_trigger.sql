-- ============================================================================
-- DEBUG: recria a função do trigger SEM EXCEPTION WHEN OTHERS
-- Assim qualquer erro vai impedir o INSERT no incidente e retornar ao cliente,
-- permitindo diagnosticar o problema.
-- Será revertido após debug.
-- ============================================================================
...
BEGIN
  ...
  RAISE NOTICE '[notify_responsaveis_on_incidente] % notifications criadas para %', v_count, NEW.protocolo;
