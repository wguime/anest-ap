-- ============================================================================
-- Relatório de adesão à Escala — Iara Grasel fora da análise (dono 2026-09-23)
-- ============================================================================
-- O dono pediu "não inclua Iara na análise". A exclusão é pelo uid, e não pelo
-- papel 'enfermeiro': ela é hoje a única enfermeira, e excluir o papel inteiro
-- tiraria também quem entrar nele depois sem ninguém ter pedido.
-- Redefine a função de 20260923120000 com esse filtro; o resto é idêntico.
--
-- ============================================================================
