-- ==========================================================================
-- Fix rpc_submit_public_incident search_path
-- Triggers (generate_protocolo, generate_tracking_code) reference
-- unqualified table names, so search_path must include 'public'
-- ==========================================================================
