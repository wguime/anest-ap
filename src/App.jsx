...
function App() {
  ...
  const handleNavigate = (page, params = null) => {
    ...
    if (['permissions', 'centroGestao', 'inbox', 'messageDetail'].includes(page)) setActiveNav(null)
    ...
    else if (['profile', 'calculadoras', 'criteriosUti', 'menuPage', 'menu', 'gerenciarResidencia', 'personalizarAtalhos', 'cateteresPeridural', 'novoCateter', 'cateterDetalhe', 'escalasFuncionarias', 'consultaSobreaviso', 'trocasSobreaviso', 'trocasPlantaoHospitalar', 'adminTodasTrocasFuncionarias', 'adminTodasTrocasResidencia'].includes(page)) setActiveNav('menu')
  ...
  const goBack = () => {
    ...
    if (['permissions', 'centroGestao', 'inbox', 'messageDetail'].includes(previous.page)) setActiveNav(null)
