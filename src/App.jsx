...
function CalculadorasPageConteudo({ _onNavigate, goBack, params, onCalculatorOpen, titulo = 'Calculadoras', calcFixa = null }) {
  ...
  const headerElement = (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-card border-b border-border shadow-sm faixa:left-[var(--faixa-lateral)]">
...
function App() {
  ...
  return (
    <div className="min-h-dvh bg-background text-foreground dark:bg-background">
      ...
      {isAuthenticated && !ehContaDeHospital(user) && <PushNotificationOptIn />}
