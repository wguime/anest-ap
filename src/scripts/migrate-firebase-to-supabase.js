...
// ============================================================================
// Firebase Admin Setup (Application Default Credentials)
// ============================================================================
...
console.log('  Firebase: Application Default Credentials (project: anest-ap)');
...
const COLLECTION_MAP = {
  ...
  // --- Medicamentos → biblioteca (com rop_area 'Uso de Medicamentos') ---
  doc_mav:                     { categoria: 'biblioteca', subcategoria: 'doc_mav' },
  doc_eletrolitos:             { categoria: 'biblioteca', subcategoria: 'doc_eletrolitos' },
  doc_heparina:                { categoria: 'biblioteca', subcategoria: 'doc_heparina' },
  doc_narcoticos:              { categoria: 'biblioteca', subcategoria: 'doc_narcoticos' },
  doc_intoxicacao_anestesicos: { categoria: 'biblioteca', subcategoria: 'doc_intoxicacao_anestesicos' },
  doc_manejo_glicemia:         { categoria: 'biblioteca', subcategoria: 'doc_manejo_glicemia' },
  doc_lista_abreviaturas:      { categoria: 'biblioteca', subcategoria: 'doc_lista_abreviaturas' },
  conciliacao_admissao:        { categoria: 'biblioteca', subcategoria: 'conciliacao_admissao' },
  conciliacao_transferencia:   { categoria: 'biblioteca', subcategoria: 'conciliacao_transferencia' },
  conciliacao_alta:            { categoria: 'biblioteca', subcategoria: 'conciliacao_alta' },

  // --- Infeccoes → biblioteca (com rop_area 'Prevenção de Infecções') ---
  protocolo_higiene_maos:                { categoria: 'biblioteca', subcategoria: 'protocolo_higiene_maos' },
  protocolo_prevencao_isc:               { categoria: 'biblioteca', subcategoria: 'protocolo_prevencao_isc' },
  protocolo_prevencao_ics:               { categoria: 'biblioteca', subcategoria: 'protocolo_prevencao_ics' },
  protocolo_prevencao_pav:               { categoria: 'biblioteca', subcategoria: 'protocolo_prevencao_pav' },
  protocolo_prevencao_itu:               { categoria: 'biblioteca', subcategoria: 'protocolo_prevencao_itu' },
  protocolo_prevencao_broncoaspiracao:    { categoria: 'biblioteca', subcategoria: 'protocolo_prevencao_broncoaspiracao' },
  protocolo_prevencao_alergia_latex:      { categoria: 'biblioteca', subcategoria: 'protocolo_prevencao_alergia_latex' },
  protocolo_institucional:               { categoria: 'biblioteca', subcategoria: 'protocolo_institucional' },
  checklist_cirurgia:                    { categoria: 'biblioteca', subcategoria: 'checklist_cirurgia' },
...
const LEGACY_COLLECTION_MAP = {
  ...
  medicamentos_documentos:     { categoria: 'biblioteca', subcategoria: 'medicamentos_documentos' },
  infeccao_documentos:         { categoria: 'biblioteca', subcategoria: 'infeccao_documentos' },
  conciliacao_documentos:      { categoria: 'biblioteca', subcategoria: 'conciliacao_documentos' },
  checklist_documentos:        { categoria: 'biblioteca', subcategoria: 'checklist_documentos' },
...
async function migrateComunicados(emailToUid) {
  ...
  const rows = docs.map(fsDoc => {
    ...
    return {
      ...
      titulo: d.titulo || d.title || 'Comunicado sem titulo',
