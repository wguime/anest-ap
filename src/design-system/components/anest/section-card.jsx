  ...
  return (
    <div
      ...
      className={cn(
        ...
        variant === "highlight"
          ? "bg-accent border border-[#A5D6A7] dark:bg-[#243530] dark:border-[#344840] dark:shadow-none"
          : "bg-card border border-[#A5D6A7] dark:bg-[#1A2420] dark:border-[#2A3F36] dark:shadow-none",
        className
      )}
      {...props}
    >
        ...
        >
          ...
          {action ? (
            <button
              ...
              className="inline-flex items-center gap-1.5 text-[13px] font-semibold text-[#006837] transition-colors hover:opacity-90 dark:text-[#2ECC71] min-h-[44px] px-2"
            >
