...
const pedPeriopCalculators = [
  {
    ...
    infoBox: {
      keyPoints: [
        ...
        'Não aplicável a neonatos na 1ª semana de vida — usar regime por dia de vida (60-150 mL/kg/dia)',
      ],
...
const hemoCalculators = [
  {
    ...
    infoBox: {
      keyPoints: [
        ...
        'Volume sanguíneo: Nadler (sexo + altura); sem altura, 75 ml/kg homem / 65 mulher / 70 sem sexo',
        'Meta de diurese: ≥0,5 ml/kg/h adulto, ≥1 ml/kg/h pediátrico — NÃO sobe com rim ruim',
        'Função renal opcional (idade + creatinina): Cockcroft-Gault, mesma fórmula do card renal',
      ...
      reference:
        'Holliday MA, Segar WE. Pediatrics 1957. | Furman EB. Anesthesiology 1975. | Gross JB. Anesthesiology 1983. | Nadler SB. Surgery 1962. | Cockcroft DW, Gault MH. Nephron 1976. | POQI-11. BJA 2024. | EMA: suspensão do HES, 2022.',
      warnings: [
        ...
        'Oligúria intraoperatória isolada é preditor FRACO de LRA — não expandir sem avaliar volemia',
        'Hidroxietilamido (HES) contraindicado com ClCr < 30: autorização suspensa na UE em 2022',
