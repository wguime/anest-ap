...
import { AlertTriangle, ShieldAlert, Clock, CheckCircle2, Search, FileText, Calendar, EyeOff, Info } from 'lucide-react';
...
export default function MeusRelatosPage({ onNavigate }) {
  ...
  return (
    <div className="min-h-dvh bg-background pb-24">
      <PageHeader title="Meus Relatos" onBack={() => onNavigate('incidentes')} />
