...
export function TrackingCodeAlert({ trackingCode, variant = 'error', type = 'denuncia' }) {
  ...
  const colors = {
    error: {
      ...
      labelColor: 'text-[#B91C1C] dark:text-[#F87171]',
      codeColor: 'text-[#991B1B] dark:text-[#FCA5A5]',
      hintColor: 'text-[#EF4444] dark:text-[#F87171]',
    },
    warning: {
      ...
      labelColor: 'text-[#92400E] dark:text-[#FBBF24]',
      codeColor: 'text-[#92400E] dark:text-[#FCD34D]',
      hintColor: 'text-[#D97706] dark:text-[#FBBF24]',
    },
  };
