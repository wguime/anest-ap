      ...
      <div className="flex-1 px-4 pb-24 pt-4 max-w-lg mx-auto w-full">
        ...
        <div className="grid grid-cols-1 gap-3 mb-4">
          ...
          <button
            ...
            className="bg-white dark:bg-[#1A2420] rounded-[20px] border border-[#C8E6C9] dark:border-[#2A3F36] p-4 shadow-sm dark:shadow-none text-left hover:shadow-md transition-shadow active:scale-[0.98]"
          >
            <div className="w-10 h-10 rounded-xl flex items-center justify-center mb-3 bg-[#E8F5E9] dark:bg-[#1A2F23]">
              <Bot className="w-5 h-5 text-[#006837] dark:text-[#2ECC71]" />
            </div>
            <p className="text-sm font-semibold text-black dark:text-white">Assistente IA</p>
            <p className="text-xs text-[#9CA3AF] dark:text-[#6B8178] mt-0.5">Dúvidas médicas e escalas</p>
          </button>
          */}
          ...
          >
            <div className="w-10 h-10 rounded-xl flex items-center justify-center mb-3 bg-[#E8F5E9] dark:bg-[#1A2F23]">
              <ArrowLeftRight className="w-5 h-5 text-[#006837] dark:text-[#2ECC71]" />
            </div>
            <p className="text-sm font-semibold text-black dark:text-white">Trocas de Plantão</p>
            <p className="text-xs text-[#9CA3AF] dark:text-[#6B8178] mt-0.5">Solicitar e gerenciar</p>
          </button>
        </div>
        ...
        {canEdit && (
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-2xl bg-white dark:bg-[#1A2420] border border-[#C8E6C9] dark:border-[#2A3F36] text-[#006837] dark:text-[#2ECC71] font-semibold text-sm shadow-sm hover:shadow-md transition-shadow active:scale-[0.98]"
          >
