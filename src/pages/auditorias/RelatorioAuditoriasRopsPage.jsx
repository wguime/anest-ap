...
import { SectionCard, Badge, useToast } from '@/design-system';
import { GraduationCap, FileBarChart, FileText, Download, Calendar, User, CheckCircle, AlertCircle, Clock } from 'lucide-react';
...
export default function RelatorioAuditoriasRopsPage({ onNavigate }) {
  ...
  return (
    <div className="min-h-dvh bg-background pb-24">
      <PageHeader title="Relatorio de Auditorias das ROPs" onBack={() => handleNavigate('auditorias')} />
