...
import { GraduationCap, Shield, FileText, CheckCircle, Target, Users, TrendingUp } from 'lucide-react';
...
export default function PoliticaGestaoQualidadePage({ onNavigate }) {
  ...
  return (
    <div className="min-h-dvh bg-background pb-24">
      <PageHeader title="Politica de Gestao da Qualidade" onBack={() => handleNavigate('auditorias')} />
