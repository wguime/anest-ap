    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white dark:bg-[#1A2420] border-b border-[#C8E6C9] dark:border-[#2A3F36] shadow-sm">
      <div className="px-4 sm:px-5 py-3">
        <div className="flex items-center justify-between">
          ...
          <h1 className="text-base font-semibold text-[#004225] dark:text-white truncate text-center flex-1 mx-2">Auditorias Operacionais</h1>
          <div className="min-w-[70px]" />
        </div>
      </div>
    </nav>
        ...
        <div className="bg-white dark:bg-[#1A2420] rounded-2xl p-4 border border-[#C8E6C9] dark:border-[#2A3F36]">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-xl bg-[#E8F5E9] dark:bg-[#2A3F36] flex items-center justify-center">
              <ClipboardCheck className="w-6 h-6 text-[#006837] dark:text-[#2ECC71]" />
            </div>
            <div>
              <h3 className="font-semibold text-[#004225] dark:text-white">Auditorias Operacionais</h3>
              <p className="text-sm text-[#6B7280] dark:text-[#6B8178]">Processos assistenciais</p>
            </div>
          </div>
        </div>

        <SectionCard title="Sobre">
          <p className="text-sm text-[#6B7280] dark:text-[#6B8178]">Esta secao consolida as auditorias operacionais relacionadas aos processos assistenciais. Inclui verificacoes de conformidade com protocolos clinicos, checagem de processos criticos e monitoramento da qualidade da assistencia prestada.</p>
        </SectionCard>
      </div>
