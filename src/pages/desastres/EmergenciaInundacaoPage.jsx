...
import { GraduationCap, Droplets, AlertTriangle, Users, Bell, UserCheck, MapPin, FileText } from 'lucide-react';
import { PageHeader } from '../../components';

// Dados do protocolo de Inundacao
const PROTOCOLO = {
  titulo: 'Inundacao / Clima Extremo',
  cor: '#2563eb',
  quando: 'Alagamento ou eventos climaticos severos',
  quem: 'Manutencao -> CGPED',
  alerta: 'Comunicacao via radio',
  equipe: 'Manutencao, Engenharia, CGPED',
  procedimentos: [
    'Desligar energia eletrica e evacuar area inundada',
    'Manutencao hidraulica remove excesso de agua',
    'Recolocar pacientes em zonas seguras',
    'Comunicar CGPED e registrar danos estruturais',
  ],
  pontos: 'Zonas elevadas e areas secas',
  registros: 'Danos estruturais, areas afetadas',
};
...
export default function EmergenciaInundacaoPage({ onNavigate }) {
  const [_activeNav, _setActiveNav] = useState('shield');

  return (
    <div className="min-h-dvh bg-background pb-24">
      <PageHeader title="Inundacao" onBack={() => onNavigate('desastres')} />
