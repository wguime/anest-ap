...
import { GraduationCap, Biohazard, AlertTriangle, Users, Bell, UserCheck, MapPin, FileText } from 'lucide-react';
import { PageHeader } from '../../components';

// Dados do protocolo de Desastre Quimico/Biologico
const PROTOCOLO = {
  titulo: 'Desastre Quimico / Biologico',
  cor: '#f59e0b',
  quando: 'Vazamento quimico, contaminacao, exposicao biologica',
  quem: 'SESMT ou CCIH -> CGPED',
  alerta: 'Isolamento imediato da area',
  equipe: 'SESMT, CCIH, Seguranca Patrimonial',
  procedimentos: [
    'Isolar area afetada',
    'Equipar EPIs',
    'Iniciar descontaminacao conforme protocolo',
    'Notificar CCIH e SESMT',
    'Registrar vitimas e medidas tomadas',
  ],
  pontos: 'Area de descontaminacao externa',
  registros: 'Vitimas expostas, tipo de contaminacao, medidas de contencao',
};
...
export default function EmergenciaQuimicoPage({ onNavigate }) {
  ...
  return (
    <div className="min-h-dvh bg-background pb-24">
      <PageHeader title="Desastre Quimico" onBack={() => onNavigate('desastres')} />
