...
import { GraduationCap, Bomb, AlertTriangle, Users, Bell, UserCheck, MapPin, FileText } from 'lucide-react';
...
export default function EmergenciaBombaPage({ onNavigate }) {
  ...
  return (
    <div className="min-h-dvh bg-background pb-24">
      <PageHeader title="Ameaca de Bomba" onBack={() => onNavigate('desastres')} />
