      ...
      <div className="px-4 sm:px-5 py-4 space-y-4">
        ...
        <div className="rounded-[20px] p-4 bg-white dark:bg-[#1A2420] border border-[#A5D6A7] dark:border-[#2A3F36] space-y-3">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="font-medium text-[#004225] dark:text-white">Dados da Nota</span>
          </div>

          <div>
            <label className="text-xs text-[#6B7280] mb-1 block">Número da Nota *</label>
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-3 bg-white dark:bg-[#212D28] border rounded-xl text-[#004225] dark:text-white placeholder-[#6B7280] focus:outline-none ${
                  errors.number
                    ? 'border-[#DC2626]'
            ...
            {errors.number && <p className="text-xs text-[#DC2626] mt-1">{errors.number}</p>}
          </div>
          ...
          <div>
            ...
            {errors.healthInsuranceId && <p className="text-xs text-[#DC2626] mt-1">{errors.healthInsuranceId}</p>}
          </div>
        </div>
        ...
        <div className="rounded-[20px] p-4 bg-white dark:bg-[#1A2420] border border-[#A5D6A7] dark:border-[#2A3F36] space-y-3">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="font-medium text-[#004225] dark:text-white">Datas</span>
          </div>

          <div>
            <label className="text-xs text-[#6B7280] mb-1 block">Data de Emissão *</label>
            <input
              type="date"
          ...
          <div>
            <label className="text-xs text-[#6B7280] mb-1 block">Vencimento</label>
            <input
              type="date"
              value={form.dueDate}
        ...
        <div className="rounded-[20px] p-4 bg-white dark:bg-[#1A2420] border border-[#A5D6A7] dark:border-[#2A3F36]">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              <Plus className="w-5 h-5 text-[#004225] dark:text-[#2ECC71]" />
              <span className="font-medium text-[#004225] dark:text-white">Eventos</span>
            </div>
          ...
          {errors.eventos && <p className="text-xs text-[#DC2626] mb-2">{errors.eventos}</p>}
          ...
          {eventosDisponiveis.length > 0 ? (
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center justify-between p-3 rounded-xl border text-left transition-all ${
                      isSelected
                        ? 'bg-[#E8F5E9] dark:bg-[#1E3A2F] border-[#004225] dark:border-[#2ECC71]'
                        : 'bg-white dark:bg-[#212D28] border-[#C8E6C9] dark:border-[#2A3F36]'
                    }`}
                  >
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      <span className="text-sm font-bold text-[#006837] dark:text-[#2ECC71]">
                        {formatarMoeda(evento.finalValue)}
                      </span>
                      {isSelected && <X className="w-4 h-4 text-[#DC2626]" />}
                    </div>
                  </button>
                );
              })}
            ...
            <p className="text-sm text-[#6B7280] text-center py-4">Nenhum evento disponível</p>
          )}
        </div>
        ...
        <div className="rounded-[20px] p-4 bg-white dark:bg-[#1A2420] border border-[#A5D6A7] dark:border-[#2A3F36]">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium text-[#004225] dark:text-white">Valor Total</span>
            </div>
