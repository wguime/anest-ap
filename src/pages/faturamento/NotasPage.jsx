    ...
    <div className="min-h-screen bg-[#F0FFF4] dark:bg-[#111916] pb-24">
      ...
      <div className="px-4 sm:px-5 py-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="rounded-[20px] p-3 bg-white dark:bg-[#1A2420] border border-[#A5D6A7] dark:border-[#2A3F36]">
            <p className="text-xs text-[#6B7280]">Total Emitido</p>
            <p className="text-lg font-bold text-[#004225] dark:text-white">
              {formatarMoeda(totais.valor)}
            </p>
            <p className="text-xs text-[#6B7280]">{totais.total} notas</p>
          </div>
          <div className="rounded-[20px] p-3 bg-white dark:bg-[#1A2420] border border-[#A5D6A7] dark:border-[#2A3F36]">
            <p className="text-xs text-[#6B7280]">Pendente</p>
            <p className="text-lg font-bold text-[#F59E0B]">
              {formatarMoeda(totais.valorPendente)}
            </p>
            <p className="text-xs text-[#6B7280]">{totais.pendente} notas</p>
          </div>
        </div>
        ...
        <div className="space-y-3">
          {loading ? (
            ...
            filteredNotas.map((nota) => {
              ...
              return (
                <button
                  ...
                  className="w-full text-left rounded-[20px] bg-white dark:bg-[#1A2420] border border-[#A5D6A7] dark:border-[#2A3F36] shadow-[0_2px_12px_rgba(0,66,37,0.06)] dark:shadow-none hover:shadow-[0_4px_16px_rgba(0,66,37,0.1)] hover:border-[#004225] dark:hover:border-[#2ECC71] transition-all"
                >
                  <div className="p-4">
                    ...
                    <div className="grid grid-cols-3 gap-2 text-sm">
                      ...
                      <div className="flex items-center gap-1 justify-end">
                        ...
                        <span className="font-bold text-[#004225] dark:text-[#2ECC71]">
            ...
            <div className="rounded-[20px] p-8 bg-white dark:bg-[#1A2420] border border-[#A5D6A7] dark:border-[#2A3F36] text-center">
              <p className="text-[#6B7280] mb-4">Nenhuma nota encontrada</p>
              <Button
                variant="default"
                leftIcon={<Plus className="w-4 h-4" />}
                onClick={() => onNavigate('faturamentoNovaNota')}
