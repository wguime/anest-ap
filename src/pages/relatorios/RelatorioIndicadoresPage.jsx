...
export default function RelatorioIndicadoresPage({ onNavigate, goBack }) {
  ...
  const {
    ...
    uploadRelatorio,
    clearError,
  } = useRelatoriosDocumentos('indicadores');
  ...
  const [uploadTipoRelatorio, setUploadTipoRelatorio] = useState('Completo');
  ...
  const handleUploadSubmit = async () => {
    ...
    try {
      await uploadRelatorio('indicadores', uploadFile, {
        titulo: uploadTitulo || uploadFile.name.replace('.pdf', ''),
        periodo: uploadPeriodo,
        tipoRelatorio: uploadTipoRelatorio,
      ...
      setUploadTitulo('');
      setUploadPeriodo('');
      setUploadTipoRelatorio('Completo');
  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <Modal
        ...
        title="Novo Relatório de Indicadores"
        description="Adicionar relatório de indicadores de qualidade"
        size="md"
          ...
          <div className="space-y-4">
            ...
            <FormField label="Título do Relatório" hint="Deixe em branco para usar o nome do arquivo">
              <Input
                ...
                placeholder="Ex: Relatório Anual de Indicadores 2024"
                disabled={uploading}
              />
            </FormField>

            <FormField label="Período" hint="Ex: Anual 2024, Semestral 1H 2024">
              <Input
                value={uploadPeriodo}
                onChange={(e) => setUploadPeriodo(e.target.value)}
                placeholder="Ex: Anual 2024"
                disabled={uploading}
              />
            </FormField>
            ...
            <FormField label="Responsável">
              <Input
                ...
                placeholder="Ex: Coordenação de Qualidade"
                disabled={uploading}
              />
            </FormField>
