...
export default function RelatorioIncidentesPage({ onNavigate, goBack }) {
  ...
  const {
    ...
    uploadRelatorio,
    clearError,
  } = useRelatoriosDocumentos('incidentes');
  ...
  const handleCardClick = (relatorio) => {
    onNavigate('relatorioDetalhe', { relatorioId: relatorio.id, tipoRelatorio: 'incidentes' });
  };
  ...
  const handleUploadSubmit = async () => {
    ...
    try {
      await uploadRelatorio('incidentes', uploadFile, {
  ...
  return (
    <div className="min-h-screen bg-[#F0FFF4] dark:bg-[#111916] pb-24">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-[#E8F5E9] dark:bg-[#243530]">
              <AlertTriangle className="w-6 h-6 text-[#006837] dark:text-[#2ECC71]" />
            </div>
            <div>
              <h2 className="text-xl font-bold text-foreground">Incidentes</h2>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            <div className="w-16 h-16 rounded-2xl bg-[#E8F5E9] dark:bg-[#243530] flex items-center justify-center mb-4">
              <AlertTriangle className="w-8 h-8 text-[#006837] dark:text-[#2ECC71]" />
            </div>
            ...
            <p className="text-sm text-[#6B7280] dark:text-[#6B8178] max-w-xs mb-4">
              {searchQuery ? 'Tente ajustar os filtros ou buscar por outro termo.' : 'Adicione o primeiro consolidado de incidentes.'}
            </p>
            {!searchQuery && (
              <AdminOnly user={user}>
                <Button
      ...
      <Modal
        ...
        title="Novo Relatório de Incidentes"
        description="Adicionar consolidado de incidentes"
        size="md"
          ...
          <div className="space-y-4">
            ...
            <FormField label="Título do Relatório" hint="Deixe em branco para usar o nome do arquivo">
              <Input
                ...
                placeholder="Ex: Consolidado de Incidentes - Dezembro 2024"
                disabled={uploading}
              />
            </FormField>

            <FormField label="Período" hint="Ex: Dezembro 2024">
              <Input
                value={uploadPeriodo}
            ...
            <FormField label="Responsável">
              <Input
                ...
                placeholder="Ex: Comitê de Segurança"
                disabled={uploading}
              />
            </FormField>
