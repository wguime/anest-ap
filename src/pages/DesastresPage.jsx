...
import { ChevronDown, Flame, Users, Zap, Biohazard, Droplets, Bomb, FileText, Info, Plus } from 'lucide-react';
        ...
        <section>
          <button
            ...
            className={cn(
              ...
              "focus:outline-none focus:ring-2 focus:ring-primary/50 dark:focus:ring-primary/50",
              "transition-all duration-200",
              openSections._siglas && "shadow-md border-primary"
            )}
          >
            <div
              className={cn(
                ...
                "w-11 h-11 rounded-xl flex-shrink-0",
                "bg-muted",
                openSections._siglas && "bg-primary"
              )}
            >
              <FileText
                className={cn(
            ...
            <ChevronDown
              className={cn(
                ...
                "text-muted-foreground dark:text-muted-foreground",
                "transition-transform duration-300 ease-out",
                openSections._siglas && "rotate-180 text-primary"
              )}
            />
          </button>
          {openSections._siglas && (
